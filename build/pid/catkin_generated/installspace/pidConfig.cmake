...
if("FALSE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/rajat/rajat_ws/src/pid)
  set(pid_DEVEL_PREFIX /home/rajat/rajat_ws/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/rajat/rajat_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rajat/rajat_ws/install/${idir}'.  ${_report}")
    endif()
